...
type AddPromotionStagiairesProps = {
    ...
    onAddStagiaireSelect: (selectedStagiaire : Stagiaire) => void
    onDeleteStagiaire: (idStagiaire : number) => void
}

const AddPromotionStagiaires : React.FC<AddPromotionStagiairesProps> = ({stagiaires, onAddStagiaireSelect, onDeleteStagiaire}) => {
  ...
  const handleAddStagiaire = (event : React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedStagiaire) {
      ...
      setNewStagiairesList(newListOfStagiaire)
      onAddStagiaireSelect(selectedStagiaire)
    }
  }
  ...
  //     ;
  //     const newStagiaireElem : Stagiaire = stagiaires[stagiaires.length-1];
  //     onAddStagiaireForm(newStagiaireElem)
  //     const newListOfStagiaire : Stagiaire[] = [...newStagiairesList, newStagiaireElem]
  //     setNewStagiairesList(newListOfStagiaire)
  ...
  return (
    <>
      <section className='stagiairesAddPromotion'>
        ...
        <div className='addStagiaireMenu'>
          <select
            ...
            >
              <option value="">-- Sélectionner un stagiaire à ajouter --</option>
